...
export function getMiniToolContent(fileEntry: ZipEntry, basePath: string = ""): Buffer | Record<string, never> {
...
export function getMiniToolMimeType(fileEntry: ZipEntry): string {
